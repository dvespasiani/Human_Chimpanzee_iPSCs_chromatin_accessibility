...
input_dir="$wd/post_processing_analyses/output/DA/sequences"
output_dir="$wd/post_processing_analyses/output/fimo_meme"

hocomoco="/data/projects/punim0586/dvespasiani/Files/Annotation_and_other_files/MEME_files/HOCOMOCOv11_core_HUMAN_mono_meme_format.meme"
